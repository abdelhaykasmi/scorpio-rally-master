...
class LocalSeedService {
  ...
  Future<void> seedDemoDataIfNeeded() async {
    ...
    // ── Users ────────────────────────────────────────────────
    final users = <AppUser>[
      AppUser(id: 'admin_1', username: 'admin',
          passwordHash: _hash('admin123'), role: UserRole.superAdmin,
          isActive: true, fullName: 'Super Administrator'),
      AppUser(id: 'org_1', username: 'marshal1',
          passwordHash: _hash('marshal123'), role: UserRole.organizer,
          isActive: true, assignedCheckpointId: 'cp_1',
          fullName: 'Marshal Alpha'),
      AppUser(id: 'org_2', username: 'marshal2',
          passwordHash: _hash('marshal123'), role: UserRole.organizer,
          isActive: true, assignedCheckpointId: 'cp_2',
          fullName: 'Marshal Bravo'),
      AppUser(id: 'org_3', username: 'marshal3',
          passwordHash: _hash('marshal123'), role: UserRole.organizer,
          isActive: true, assignedCheckpointId: 'cp_3',
          fullName: 'Marshal Charlie'),
      AppUser(id: 'p_001', username: 'rider001',
          passwordHash: _hash('rider123'), role: UserRole.participant,
          isActive: true, fullName: 'Carlos Sainz Jr.',
          bikeBrand: 'KTM', bikeModel: '450 EXC-F', engineSize: 450,
          bibNumber: '001', nationality: 'Spanish',
          emergencyContactName: 'Maria Sainz',
          emergencyContactPhone: '+34 600 111 222'),
      AppUser(id: 'p_002', username: 'rider002',
          passwordHash: _hash('rider123'), role: UserRole.participant,
          isActive: true, fullName: 'Nasser Al-Attiyah',
          bikeBrand: 'Husqvarna', bikeModel: 'FR 450 Rally', engineSize: 450,
          bibNumber: '002', nationality: 'Qatari',
          emergencyContactName: 'Fatima Al-Attiyah',
          emergencyContactPhone: '+974 5555 1234'),
      AppUser(id: 'p_003', username: 'rider003',
          passwordHash: _hash('rider123'), role: UserRole.participant,
          isActive: true, fullName: 'Toby Price',
          bikeBrand: 'KTM', bikeModel: '450 Rally', engineSize: 450,
          bibNumber: '003', nationality: 'Australian',
          emergencyContactName: 'Luke Price',
          emergencyContactPhone: '+61 400 333 444'),
      AppUser(id: 'p_004', username: 'rider004',
          passwordHash: _hash('rider123'), role: UserRole.participant,
          isActive: true, fullName: 'Adrien Van Beveren',
          bikeBrand: 'Honda', bikeModel: 'CRF450 Rally', engineSize: 450,
          bibNumber: '004', nationality: 'French',
          emergencyContactName: 'Claire Van Beveren',
          emergencyContactPhone: '+33 6 00 44 55 66'),
      AppUser(id: 'p_005', username: 'rider005',
          passwordHash: _hash('rider123'), role: UserRole.participant,
          isActive: true, fullName: 'Pablo Quintanilla',
          bikeBrand: 'GASGAS', bikeModel: 'RC 450F', engineSize: 450,
          bibNumber: '005', nationality: 'Chilean',
    ...
    final checkpoints = <Checkpoint>[
      Checkpoint(id: 'cp_1', eventId: 'event_2024',
          name: 'CP1 — Dune Gateway', order: 1,
          description: 'Start of the dune sector, Erg Chebbi entrance',
          latitude: 31.3667, longitude: -4.0,
          assignedOrganizerId: 'org_1',
          assignedOrganizerName: 'Marshal Alpha'),
      Checkpoint(id: 'cp_2', eventId: 'event_2024',
          name: 'CP2 — Canyon Pass', order: 2,
          description: 'Rocky canyon section midpoint',
          latitude: 31.5, longitude: -4.25,
          assignedOrganizerId: 'org_2',
          assignedOrganizerName: 'Marshal Bravo'),
      Checkpoint(id: 'cp_3', eventId: 'event_2024',
          name: 'CP3 — Atlas Summit', order: 3,
          description: 'High altitude mountain checkpoint',
          latitude: 31.65, longitude: -4.5,
          assignedOrganizerId: 'org_3',
          assignedOrganizerName: 'Marshal Charlie'),
      Checkpoint(id: 'cp_4', eventId: 'event_2024',
          name: 'CP4 — Desert Bivouac', order: 4,
          description: 'Central bivouac refuelling point',
          latitude: 31.8, longitude: -4.75),
      Checkpoint(id: 'cp_5', eventId: 'event_2024',
          name: 'FINISH — Merzouga', order: 5,
          description: 'Final finish line at Merzouga town',
          latitude: 31.1, longitude: -3.97),
    ];
    ...
    final passages = <CheckpointPassage>[
      CheckpointPassage(id: 'pass_001_cp1', eventId: 'event_2024',
          checkpointId: 'cp_1', checkpointName: 'CP1 — Dune Gateway',
          participantId: 'p_001', participantName: 'Carlos Sainz Jr.',
          bibNumber: '001',
      ...
      CheckpointPassage(id: 'pass_002_cp1', eventId: 'event_2024',
          checkpointId: 'cp_1', checkpointName: 'CP1 — Dune Gateway',
          participantId: 'p_002', participantName: 'Nasser Al-Attiyah',
          bibNumber: '002',
          localTime: now.subtract(const Duration(hours: 3, minutes: 5)),
          utcTime: now.subtract(const Duration(hours: 3, minutes: 5)).toUtc(),
          syncStatus: SyncStatus.synced),
      CheckpointPassage(id: 'pass_003_cp1', eventId: 'event_2024',
          checkpointId: 'cp_1', checkpointName: 'CP1 — Dune Gateway',
          participantId: 'p_003', participantName: 'Toby Price',
          bibNumber: '003',
          localTime: now.subtract(const Duration(hours: 2, minutes: 58)),
          utcTime: now.subtract(const Duration(hours: 2, minutes: 58)).toUtc(),
          syncStatus: SyncStatus.synced),
      CheckpointPassage(id: 'pass_001_cp2', eventId: 'event_2024',
          checkpointId: 'cp_2', checkpointName: 'CP2 — Canyon Pass',
          participantId: 'p_001', participantName: 'Carlos Sainz Jr.',
          bibNumber: '001',
          localTime: now.subtract(const Duration(hours: 1, minutes: 45)),
          utcTime: now.subtract(const Duration(hours: 1, minutes: 45)).toUtc(),
          syncStatus: SyncStatus.synced),
      CheckpointPassage(id: 'pass_002_cp2', eventId: 'event_2024',
          checkpointId: 'cp_2', checkpointName: 'CP2 — Canyon Pass',
          participantId: 'p_002', participantName: 'Nasser Al-Attiyah',
          bibNumber: '002',
